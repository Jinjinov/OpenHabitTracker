...
public static class EntityToModel
{
    ...
    public static void CopyToModel(this CategoryEntity entity, CategoryModel model)
    {
        ...
        model.IsCollapsed = entity.IsCollapsed;
        model.CompletionRule = entity.CompletionRule;
    }
    ...
    public static void CopyToModel(this HabitEntity entity, HabitModel model)
    {
        ...
        model.DisplayMetric = entity.DisplayMetric;
    ...
    public static void CopyToModel(this SettingsEntity entity, SettingsModel model)
    {
        ...
        model.ShowHabitCharts = entity.ShowHabitCharts;
        ...
        model.ShowGroupedByCategory = entity.ShowGroupedByCategory;
        ...
        model.PlannedFromDayOffset = entity.PlannedFromDayOffset;
        model.PlannedToDayOffset = entity.PlannedToDayOffset;
        model.DoneFromDayOffset = entity.DoneFromDayOffset;
        model.DoneToDayOffset = entity.DoneToDayOffset;
        model.ShowDoneInRange = entity.ShowDoneInRange;
        model.HorizontalMargin = entity.HorizontalMargin;
        model.VerticalMargin = entity.VerticalMargin;
        model.NotificationTime = entity.NotificationTime;
        model.NotificationLeadMinutes = entity.NotificationLeadMinutes;
        model.NotificationContent = entity.NotificationContent;
        model.NotificationMinimumPriority = entity.NotificationMinimumPriority;
        model.NotificationHabitThreshold = entity.NotificationHabitThreshold;
        model.NotificationIncludeOverdueTasks = entity.NotificationIncludeOverdueTasks;
