...
### Phase 2: bUnit component tests — Blazor rendering
...
Available transitively via the project reference to `OpenHabitTracker.Blazor` — no extra NuGet needed.
