...
https://github.com/pluja/awesome-privacy?tab=readme-ov-file#notes-and-tasks
https://github.com/Lissy93/awesome-privacy?tab=readme-ov-file#productivity
https://github.com/AdrienTorris/awesome-blazor?tab=readme-ov-file#todos
https://github.com/woop/awesome-quantified-self?tab=readme-ov-file#habits
https://github.com/jyguyomarch/awesome-productivity?tab=readme-ov-file#habit-trackers
https://github.com/unicodeveloper/awesome-opensource-apps?tab=readme-ov-file#c

1. awesome-selfhosted

cd ~/awesome-prs/awesome-selfhosted
git add README.md
git commit -m "Add OpenHabitTracker to Time Tracking"
git push
gh pr create --title "Add OpenHabitTracker to Time Tracking" --body "OpenHabitTracker is a free, open source habit tracker with time tracking, calendar view and completion statistics. Self-hostable via Docker. GPL-3.0. https://openhabittracker.net"

2. pluja/awesome-privacy

cd ~/awesome-prs/awesome-privacy
git add README.md
git commit -m "Add OpenHabitTracker to Notes and Tasks"
git push
gh pr create --title "Add OpenHabitTracker to Notes and Tasks" --body "OpenHabitTracker is a free, open source, cross-platform habit tracker. All data stored locally or self-hosted via Docker. No accounts required. https://openhabittracker.net"

3. Lissy93/awesome-privacy

cd ~/awesome-prs/awesome-privacy-1
git add awesome-privacy.yml
git commit -m "Add OpenHabitTracker to Digital Notes"
git push
gh pr create --title "Add OpenHabitTracker to Digital Notes" --body "OpenHabitTracker is a free, open source habit tracker. Take notes, plan tasks, and track habits. All data stored locally or self-hosted via Docker. No accounts required. https://openhabittracker.net"

4. AdrienTorris/awesome-blazor

cd ~/awesome-prs/awesome-blazor
git add README.md
git commit -m "Add OpenHabitTracker to Todos"
git push
gh pr create --title "Add OpenHabitTracker to Todos" --body "OpenHabitTracker is a free, open source Blazor habit tracker for Web, Windows, Linux, Android, iOS and macOS. Take notes, plan tasks, track habits. https://openhabittracker.net"

5. woop/awesome-quantified-self

cd ~/awesome-prs/awesome-quantified-self
git add README.MD
git commit -m "Add OpenHabitTracker to Habits"
git push
gh pr create --title "Add OpenHabitTracker to Habits" --body "OpenHabitTracker is a free, open source habit tracker with notes and tasks, available on Web, Windows, Linux, Android, iOS and macOS. https://openhabittracker.net"

6. jyguyomarch/awesome-productivity

cd ~/awesome-prs/awesome-productivity
git add README.md
git commit -m "Add OpenHabitTracker to Habit Trackers"
git push
gh pr create --title "Add OpenHabitTracker to Habit Trackers" --body "OpenHabitTracker is a free, open source habit tracker for Web, Windows, Linux, Android, iOS and macOS. Tracks habits without streak counters. https://openhabittracker.net"

7. unicodeveloper/awesome-opensource-apps

cd ~/awesome-prs/awesome-opensource-apps
git add README.md
git commit -m "Add OpenHabitTracker to C#"
git push
gh pr create --title "Add OpenHabitTracker to C#" --body "OpenHabitTracker is a free, open source C#/.NET Blazor habit tracker for Web, Windows, Linux, Android, iOS and macOS. https://openhabittracker.net"

https://github.com/quozd/awesome-dotnet - NONE
https://github.com/thangchung/awesome-dotnet-core - NONE
https://github.com/jsuarezruiz/awesome-dotnet-maui - NONE
